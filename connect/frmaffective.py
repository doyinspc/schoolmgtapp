# -*- coding: utf-8 -*-
"""
Created on Thu Aug  9 12:14:30 2018
...
from frmaffectivetype import AffectiveTypeForm

class AffectiveForm(QDialog):
    pagetitle = 'Psychomotor/Skills Manager'
    def __init__(self, parent=None):
        super(AffectiveForm, self).__init__(parent)
    ...
    def lunchUnitForm(self, a, b):
        ...
        b.close()
        self.a = a
        self.form = AffectiveTypeForm(self.a)
        self.form.show()
...
class AddForm(QDialog):    
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("Skills Manager")
    ...
    def button_click(self, a):
        ...
        try:
            if(len(s1) > 0) and (len(s2) > 0):
                y = { 'name':s1.lower(), 'abbrv':s2.lower(), 'pubID':11, 'active':0}
                k = g.insert('datas', y)
                print(k)
            else:
                pass
...
class EditForm(QDialog): 
    ...
    def __init__(self, sid, parent=None):
        ...
        self.connect(self.pb1, SIGNAL("clicked()"),lambda: self.button_close(self))
        self.setWindowTitle("Psychomotor/Skills Manager")
