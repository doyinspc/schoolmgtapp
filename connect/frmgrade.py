...
from frmgrading import GradingForm

class GradeForm(QDialog):
    pagetitle = 'Grading Manager'
    def __init__(self, parent=None):
        super(GradeForm, self).__init__(parent)
        ...
        groupBox1 = QGroupBox('Grading System')
        groupBox1.setLayout(layout1)
        
        self.pb = QPushButton()
        self.pb.setObjectName("Add")
        self.pb.setText("Add Grading")
...
class AddForm(QDialog):    
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("Grading Manager")
